...
export default function Home() {
  return (
    <main className="relative p-8 md:p-24 flex flex-col gap-6 h-screen">
      ...
      <p className="text-xl md:text-2xl">Need a hand? <a href='/samuel_alegre_castro_cv.pdf' className="underline hover:italic">Hire me!</a></p>
      <p className="text-xl md:text-2xl">Or just <a href='mailto:samuelalecas@gmail.com' className="underline hover:italic">say hi!</a></p>
      <a href='https://www.youtube.com/watch?v=isHPraVICUA' className="absolute bottom-10 right-10 text-[6rem] hover:animate-spin hover:cursor-pointer"><div className="transition-all duration-200 ease-in-out scale-100 hover:scale-110"><Smile/></div></a>
    </main>
  );
}
